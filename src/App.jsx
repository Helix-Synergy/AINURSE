  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path= "/ainurse-orators"  element={<Orators />} />
        <Route path="/about-ainurse" element={<AboutOralMed />} />
        <Route path="/ainurse-event-schedule"element={<EventSchedule />} />
        <Route path="/venue" element={<Venue/>}/>
        <Route path="/contact" element={<ContactForm />} />
        <Route path="/ainurse-conference-tracks/" element={<RotatingLogos />} />
